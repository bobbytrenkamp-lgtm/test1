# AI Changelog — Archive (2026-07-09 through 2026-07-18)

Older entries moved out of `AI_CHANGELOG.md` on 2026-07-31 to keep the live
file under the ~256KB size a single `Read` call can load — `AI_CHANGELOG.md`
had grown to 355KB and needed manual offset/limit reads to see fully, which
works against the project's own rule that every AI assistant read it before
coding. This is a pure move: no content was changed or removed, only
relocated. See `AI_CHANGELOG.md` for 2026-07-18 onward and this file for
