  ...
  const JURISDICTIONS = {
    ...
    '51107': {
      ...
      attribution: {
        ...
        license: "Loudoun County states its GIS data is public information with no license required to use it (per loudoun.gov and the GeoHub site), but disclaims all warranties of accuracy/completeness and liability for reliance on the data. No explicit clause on commercial resale/redistribution was found via web search (2026-08-16); verify directly before commercial use.",
        license_status: 'OPEN',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: false,
        confidence_level: 'medium',
        reviewed_date: '2026-08-19',
    ...
    '51153': {
      ...
      attribution: {
        ...
        license: 'The county’s GIS disclaimer (gisweb.pwcva.gov/webapps/ago/disclaimer.htm, found via web search 2026-08-18) states services/data are provided “as is”/“as available,” disclaims warranties of merchantability and fitness for a particular purpose, and notes the data does not represent legal boundary descriptions. No explicit commercial-use or redistribution restriction was surfaced in the disclaimer text found. Verify terms before commercial redistribution.',
        license_status: 'TERMS_UNCLEAR',
    ...
    '51059': {
      ...
      attribution: {
        ...
        license: "Fairfax County's Open Geospatial Data site lists most layers under a 'Custom License' (per data-fairfaxcountygis.opendata.arcgis.com), and the county's GIS disclaimer (fairfaxcounty.gov/maps/disclaimer) states no warranty of accuracy/completeness and restricts use of topography/boundary data for design, construction, or floodplain determination. Full text of the 'Custom License' wasn't retrievable in this environment (direct page fetch blocked); verify its terms directly before commercial use (found via web search 2026-08-16).",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '24031': {
      ...
      attribution: {
        ...
        license: 'Served from Maryland’s statewide MD iMap parcel layer, not a Montgomery County-specific service; per web search 2026-08-18, iMap’s stated distribution terms allow the data to be freely distributed provided the metadata entry is not modified or deleted, and require any data derived from it to acknowledge the State of Maryland in the metadata — a real attribution condition. Otherwise provided “as is” with no warranty of accuracy and no liability accepted by the State. Verify terms before commercial redistribution.',
    ...
    '24027': {
      ...
      attribution: {
        ...
        portal:  'https://data.imap.maryland.gov/',
        license: 'Same statewide MD iMap source as Montgomery County MD above; per web search 2026-08-18, iMap’s terms permit free redistribution as long as the metadata entry is left unmodified, and require derived data to credit the State of Maryland in its metadata. Data is otherwise “as is,” with no warranty of accuracy and no state liability. Verify terms before commercial redistribution.',
        license_status: 'ATTRIBUTION_REQUIRED',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: true,
    ...
    '24510': {
      ...
      attribution: {
        ...
        portal:  'https://data.imap.maryland.gov/',
        license: 'Same statewide MD iMap source used for this registry’s other Maryland counties (filtered here to JURSCODE=\'BACI\'); per web search 2026-08-18, iMap’s stated terms allow free distribution provided the metadata entry isn’t altered, and require derived data to acknowledge the State of Maryland. Otherwise “as is,” no warranty, no state liability for accuracy. Verify terms before commercial redistribution.',
        license_status: 'ATTRIBUTION_REQUIRED',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: true,
    ...
    '24033': {
      ...
      attribution: {
        ...
        portal:  'https://data.imap.maryland.gov/',
        license: 'Same statewide MD iMap source as this registry’s other Maryland counties (filtered here to JURSCODE=\'PRIN\'); per web search 2026-08-18, iMap permits free redistribution so long as the metadata entry is preserved unmodified, and requires derived products to credit the State of Maryland in metadata. No warranty of accuracy is offered and the State disclaims liability. Verify terms before commercial redistribution.',
        license_status: 'ATTRIBUTION_REQUIRED',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: true,
    ...
    '04013': {
      ...
      attribution: {
        ...
        license: "Maricopa County Assessor data is governed by a separate Parcel Data Sales Policy covering licensing, cost, redistribution limits, and attribution; Arizona statute treats undisclosed commercial use of public records as a violation subject to treble-damages liability, and the county says data supplied to agencies is not to be used/distributed for commercial gain. Data is 'deemed reliable but not guaranteed.' Commercial use likely requires review of the Assessor's sales/licensing policy, not open redistribution (found via web search 2026-08-16, sales policy document itself not directly fetched).",
    ...
    '48113': {
      ...
      attribution: {
        ...
        license: "2026-08-19 (Priority D): the actual registered service is the City of Dallas's parcel layer (gis.dallascityhall.com), not Dallas County's own portal -- the earlier pass checked the wrong jurisdiction's site. Web search located a real \"City of Dallas GIS Data Disclaimer\" document (egisdata-dallasgis.hub.arcgis.com), whose surfaced content is a standard survey-accuracy disclaimer: not produced by a Registered Professional Land Surveyor, for informational purposes only, not suitable for legal/engineering/surveying use. No explicit commercial-use or redistribution clause was found in the material surfaced. A general claim that Texas GIS data carries a \"de jure public domain license\" under the Texas Public Information Act also surfaced during research, but that Act governs the right to REQUEST/access records, not redistribution/commercial-use terms specifically -- treating it as equivalent to an explicit public-domain data license would be exactly the kind of inference this project's licensing research avoids. Verify the actual disclaimer document directly before commercial use.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '13121': {
      ...
      attribution: {
        ...
        license: "Fulton County's data disclaimer says its data contains known errors/inconsistencies and the county in no way ensures, represents, or warrants accuracy or reliability for any purpose; individual datasets have been described elsewhere as freely usable with credit, but no blanket commercial-use or redistribution policy for the current gisdata.fultoncountyga.gov portal was found via web search (2026-08-16). Treat commercial-use terms as unverified.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '53033': {
      ...
      attribution: {
        ...
        license: "King County's Open Data Terms and Conditions (kingcounty.gov/.../datatermsofuse) grant a limited, revocable license to use, reproduce, and redistribute the data 'AS IS'/'AS AVAILABLE' with no warranty of any kind — with one explicit restriction: nobody may sell the data except under a separate written agreement with King County. Redistribution appears allowed; resale is not, absent a licensing agreement.",
        license_status: 'RESTRICTED',
        commercial_use_status: 'restricted',
        redistribution_status: 'restricted',
        attribution_required: null,
    ...
    '39049': {
      ...
      attribution: {
        ...
        license: "Franklin County Auditor's disclaimer (auditor.franklincountyohio.gov/Auditor/Disclaimer) states site content is for general informational purposes only, offers no warranty of completeness/reliability/accuracy, and that actions taken based on it are at the user's own risk. No explicit commercial-use or redistribution clause was found via web search (2026-08-16); verify directly before commercial use.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '06037': {
      ...
      attribution: {
        ...
        license: "LA County Enterprise GIS publishes a dedicated Terms of Use page (egis-lacounty.hub.arcgis.com/pages/terms-of-use) with sections on License, No Warranties, Limitation of Liability, Indemnity, and 'Citing County of Los Angeles GIS Data' — the citation section implies attribution is expected. Full text of the license grant (incl. whether commercial use/resale is restricted) wasn't retrievable in this environment (direct page fetch blocked); confirmed only via search-result summary (2026-08-16), so verify the actual terms before commercial use.",
        license_status: 'ATTRIBUTION_REQUIRED',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: true,
    ...
    '48201': {
      ...
      attribution: {
        ...
        license: "HCAD's disclaimer (hcad.org/hcad-help/hcad-disclaimer/) states all HCAD information, including geospatial/map data, is distributed without warranty of any kind and is for informational purposes only, not suitable for legal/engineering/survey use. No explicit commercial-use or redistribution clause was found via web search (2026-08-16); verify directly before commercial use.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '36061': {
      ...
      attribution: {
        ...
        license: "Per NYC's Local Law 11 of 2012 (Open Data Law) and the NYC Open Data Terms of Use, city open datasets including MapPLUTO are published without registration, license, or usage restriction beyond the standard 'as is' disclaimer (no warranty of accuracy/completeness/fitness for purpose). This is among the most permissive licenses found in this review — no commercial-use restriction identified.",
        license_status: 'OPEN',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: false,
    ...
    '48453': {
      ...
      attribution: {
        ...
        license: "TCAD's property-search terms state the data is 'in the public domain' and distributed without warranty of any kind, but also state the site 'is not intended for the bulk transfer of data' — a caveat directly relevant to programmatic/bulk collection for a commercial product. Verify before any large-scale automated pull (found via web search 2026-08-16).",
        license_status: 'RESTRICTED',
        commercial_use_status: 'restricted',
        redistribution_status: 'restricted',
        attribution_required: null,
    ...
    '12086': {
      ...
      attribution: {
        ...
        license: "Miami-Dade Property Appraiser's Liability Disclaimer and User Agreement (miamidadepa.gov/pa/disclaimer.page) covers governing law/jurisdiction (Florida, Miami-Dade courts), indemnification, and liability limits, but the text retrievable via web search (2026-08-16) did not include an explicit clause on commercial use or redistribution. Treat that specific point as unverified.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '48029': {
      ...
      attribution: {
        ...
        license: 'Public government data. Verify terms before commercial redistribution. [Checked bcad.org, help.bcad.org, and gis-bexar.opendata.arcgis.com via web search 2026-08-16; found only a data-download license-agreement acknowledgment step and unrelated public-records/privacy provisions, no substantive commercial-use or redistribution terms. No usable terms page found.]',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '49035': {
      ...
      attribution: {
        ...
        license: "Per UGRC's data license and disclaimer policy (gis.utah.gov/about/policy/license-disclaimer/), SGID data including county parcels is licensed under Creative Commons Attribution 4.0 International (CC BY 4.0) by default unless a dataset's own metadata says otherwise — commercial use is permitted provided UGRC (and the source county) is credited and any changes made to the data are indicated. Genuinely permissive with a clear attribution requirement.",
        license_status: 'ATTRIBUTION_REQUIRED',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: true,
    ...
    '41051': {
      ...
      attribution: {
        ...
        license: 'Multnomah County’s own GIS pages (multco.us/gis and its ArcGIS services documentation, per web search 2026-08-18) state the county “makes no warranties or representations whatsoever regarding the quality, content, completeness, accuracy or adequacy” of its GIS data and reserves the right to change it without notice. No explicit commercial-use or redistribution restriction was found in the material surfaced. Verify terms before commercial redistribution.',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '47037': {
      ...
      attribution: {
        ...
        license: "Nashville.gov's Terms of Service state Metro Government retains copyright on site content, permits personal use/printing, and explicitly prohibits commercial use of the materials without Metro's written permission; the mapping-data disclaimer separately says parcel/GIS data is provided 'as is' with no warranty and users waive claims for damages arising from its use. Commercial use likely requires Metro's written permission — a real, non-boilerplate restriction, found via web search 2026-08-16.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '42101': {
      ...
      attribution: {
        ...
        license: 'OpenDataPhilly’s terms of use (opendataphilly.org, per web search 2026-08-18) state that for City of Philadelphia datasets “the City of Philadelphia reserves all rights in the database,” the data is offered “as is” without warranty, and users must hold the City harmless from claims arising from its use; the site’s FAQ separately advises commercial/for-profit users to confirm terms with the originating agency. Not a blanket public-domain dedication — verify terms before commercial redistribution.',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '06067': {
      ...
      attribution: {
        ...
        license: 'Sacramento County Assessor’s parcel-viewer disclaimer page (assessor.saccounty.gov, per web search 2026-08-18) states the mapped parcel data is “for assessment purposes only,” may contain inaccuracies, and is provided “as is” with no representation of suitability for any particular purpose. No explicit commercial-use or redistribution clause was surfaced. Verify terms before commercial redistribution.',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '39035': {
      ...
      attribution: {
        ...
        license: 'Cuyahoga County’s GIS disclaimer/terms-of-use item (gis.cuyahogacounty.us, per web search 2026-08-18) states the data is a free public service offered “as is” with no guarantee of accuracy and is not an official public record, and explicitly requires that any permitted reproduction — e.g. a property report or map excerpt — “include clear source attribution.” A real, if modest, attribution requirement.',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '37183': {
      ...
      attribution: {
        ...
        license: 'Wake County’s GIS Terms of Use page (maps.wakegov.com/agso/OpenData/TermsOfUse.html, per web search 2026-08-18) disclaims liability for errors, states the data “cannot be construed to be a legal document,” and directs users to primary sources for verification. [Partially unresearched: this sandbox could not fetch the page directly (egress-blocked) to confirm whether it also states a commercial-use or redistribution position; only the disclaimer language above was confirmed via search 2026-08-18.]',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '19153': {
      ...
      attribution: {
        ...
        license: 'Polk County\'s GIS disclaimer page (polkcountyia.org/gis) states the data is compiled for government purposes only and disclaims all warranties of accuracy, completeness, or reliability, adding that the county is not responsible for use of the information for any non-governmental purpose — a caution against outside use rather than an explicit commercial-use ban. Verify terms before commercial redistribution. (Per web search 2026-08-18; the page itself could not be directly fetched — .gov domains are blocked by this environment\'s network egress proxy — so this rests on search-result excerpts, not a firsthand read.)',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '41067': {
      ...
      attribution: {
        ...
        license: "Oregon Metro's RLIS data is normally governed by the RLIS Limited Use License Agreement (oregonmetro.gov), which permits distribution within a licensee's own network/systems but requires derivative products to display '© Oregon Metro www.oregonmetro.gov/rlis' plus the date received, and reserves all of Metro's IP rights. This dataset, however, is served through RLIS Discovery's open-data (ArcGIS Hub) side, which Metro documents as using a separate, more open 'open database end-user license' than the Limited Use License — the two are not identical, so confirm which one actually governs this taxlots-public layer before commercial use (found via web search 2026-08-16).",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '25025': {
      ...
      attribution: {
        ...
        license: 'MassGIS states its data is paid for by public tax dollars and is therefore in the public domain, usable by anyone for any purpose including commercial use, with source credit ("MassGIS (Bureau of Geographic Information), Commonwealth of Massachusetts EOTSS") appreciated but not required — genuinely permissive. (Per web search 2026-08-18, from mass.gov/MassGIS FAQ and data-hub pages; not directly fetchable — mass.gov is blocked by this environment\'s network egress proxy.)',
    ...
    '12057': {
      ...
      attribution: {
        ...
        license: 'The Hillsborough County Property Appraiser\'s disclaimer and terms-and-conditions pages (hillsboroughcountypropertyappraiser.us) state data is for personal/informational use and explicitly bar republishing property records or assessments for commercial purposes or unsolicited commercial redistribution, with misuse subject to legal consequences — a real, specific commercial-use restriction. Verify terms before commercial redistribution. (Per web search 2026-08-18; pages not directly fetchable from this environment. This layer is served via the Tampa Hillsborough Planning Commission\'s GIS mirror, and whether that mirror carries the same terms as the Property Appraiser\'s own site is unconfirmed.)',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '25017': {
      ...
      attribution: {
        ...
        url:     'https://www.mass.gov/orgs/massgis-bureau-of-geographic-information',
        portal:  'https://gis.data.mass.gov/datasets/massgis::gisdata-l3-assess',
        license: 'Same statewide MassGIS terms as Suffolk County, Massachusetts elsewhere in this registry: data is public-domain, taxpayer-funded, and usable for any purpose including commercial use, with source credit appreciated but not required — genuinely permissive. (Per web search 2026-08-18; mass.gov pages not directly fetchable from this environment.)',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '39061': {
      ...
      attribution: {
        ...
        license: 'Hamilton County\'s general disclaimer page (hamiltoncountyohio.gov/government/disclaimer) states the county makes no warranties, express or implied, as to the accuracy of website content, and CAGIS\'s own GIS-download page requires users to acknowledge a disclaimer before downloading data; no explicit commercial-use or redistribution restriction was surfaced beyond that standard accuracy/warranty disclaimer. Verify terms before commercial redistribution. (Per web search 2026-08-18; the CAGIS download page\'s disclaimer-acknowledgment text itself could not be directly fetched — .gov domains are blocked by this environment\'s network egress proxy.)',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '42003': {
      ...
      attribution: {
        ...
        license: 'PASDA\'s standard terms of use (which govern this mirrored Allegheny County layer) state data files are provided "as is" with no warranty, require the user to indemnify/hold the source county harmless, and explicitly bar the data or derivative products from being "sold, distributed, or loaned for profit, or used on a for-profit web site" without express written consent of the PA Governor\'s Office of Administration\'s Bureau of Geospatial Technologies — a real, specific commercial-use restriction. Verify before commercial redistribution. (Per web search 2026-08-18; PASDA\'s own page could not be directly fetched — pasda.psu.edu is blocked by this environment\'s network egress proxy.)',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '18097': {
      ...
      attribution: {
        ...
        license: 'IndyGIS\'s own Legal Disclaimers page (maps.indy.gov/OpenDataPortal/disclaimer) states data is provided "as is"/"as available" without warranty, is intended for reference only, and explicitly states the data "may not be sold, published, or exchanged for commercial purposes," with a citation recommended when used in a new publication — a real, specific commercial-use restriction. Verify terms before any commercial redistribution. (Per web search 2026-08-18; page itself could not be directly fetched — indy.gov is blocked by this environment\'s network egress proxy.)',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '48439': {
      ...
      attribution: {
        ...
        license: '2026-08-19 (Priority D): re-checked via web search, confirming and extending the prior finding rather than replacing it -- tad.org\'s "terms and conditions" remain confirmed as covering its property-owner online-account portal, not GIS data licensing. New this pass: the actual registered service (mapit.tarrantcounty.com/.../Tax/TCProperty) is independently described in search results as copyrighted by the Tarrant County Tax Assessor-Collector and Tarrant Appraisal District jointly -- a real, explicit copyright claim, though not itself a statement on whether commercial use or redistribution is permitted or restricted. No jurisdiction-specific GIS/parcel-data terms-of-use page was surfaced for mapit.tarrantcounty.com itself. Verify directly before commercial use.',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '26163': {
      ...
      attribution: {
        ...
        license: 'Wayne County\'s own GIS Parcel Data page (waynecountymi.gov) states: "Wayne County is not responsible for the content or accuracy of the data contained in the shapefiles... provided for reference only and without warranty of any kind, expressed or inferred" — a standard accuracy disclaimer; no explicit commercial-use or redistribution restriction was surfaced. Verify terms before commercial redistribution. (Per web search 2026-08-18; page itself could not be directly fetched — waynecountymi.gov is blocked by this environment\'s network egress proxy.)',
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '11001': {
      ...
      attribution: {
        ...
        license: 'DC\'s Open Data terms ("Terms and Conditions of Use for District Data" at dc.gov, governing opendata.dc.gov) place the data in the public domain under a CC0 1.0 Universal dedication: the District explicitly permits copying, modifying, distributing, and using the data — including for commercial purposes — without asking permission, only requests (does not require) attribution, and disclaims all warranties. Genuinely permissive. (Per web search 2026-08-18, corroborated across two independent searches; dc.gov/opendata.dc.gov pages themselves could not be directly fetched — blocked by this environment\'s network egress proxy.)',
        license_status: 'PUBLIC_DOMAIN',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: false,
    ...
    '12031': {
      ...
      attribution: {
        ...
        license: "The City of Jacksonville's GIS disclaimer (coj.net, covering its GIS mapping applications — Duval Property Map, My Neighborhood Map, Land Development Review — that host this same parcel data) states the City provides no warranties, expressed or implied, concerning accuracy, completeness, reliability, or suitability of the data for any particular use, and assumes no liability whatsoever for its use or misuse. That is a standard non-warranty disclaimer, not an explicit commercial-use or redistribution restriction. Checked via web search 2026-08-18; a third-party lookalike site (duvalcountypropertyappraiser.org, part of a templated network of similarly-named sites for unrelated counties) surfaced in results and was deliberately not used since it is not an official City of Jacksonville/Duval County domain.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '21111': {
      ...
      attribution: {
        ...
        license: "LOJIC's GIS Open Data Policy and Data Package License (lojic.org) impose a real, specific commercial-use restriction: \"No license is granted to commercially reproduce and/or distribute any LOJIC GIS data or products derived therefrom unless specifically provided in the Agreement,\" with cost-recovery fees applying to commercial use under KRS 61, and a copyright/source-acknowledgement notice required as a material term of use. Checked via web search 2026-08-18.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
        ...
        note:    'Louisville metro — Kentucky data center market. Louisville and Jefferson County are a consolidated city-county government ("Louisville Metro"). This is a pure cadastral-geometry layer (PARCELID, PIN, an internal PARCEL_TYPE code, and an LRSN record-sequence number) with no owner/address/value fields exposed — a thin add, consistent with the precedent set by Middlesex County MA, Allegheny County PA, and District of Columbia this session. ' +
                 '2026-08-19 Priority B finding: data_health.json flags this FIPS as parcels_registry SOURCE_DOWN, but parcel_health_history.json shows exactly ONE recorded run (2026-08-15, errorType "unknown") -- generate_data_health.py deliberately treats a first-ever recorded failure with no prior history as confirmed-down by design (matching check_parcel_services.mjs\'s own aggressive first-failure rule), so "SOURCE_DOWN" here reflects that policy, not multiple observed failures. Web search independently surfaced this exact URL indexed under the title "Layer: Jefferson County KY Parcels (ID: 1)" -- the title format a live ArcGIS REST layer page actually serves -- which is inconsistent with the service having moved or retired. serviceUrl is NOT changed: there is no real evidence it is wrong, only one ambiguous "unknown"-classified failure. Needs a real second live probe (this sandbox cannot fetch ArcGIS endpoints directly) before treating this as confirmed rather than a possible single transient blip or bot-block.',
      },
    },
    ...
    '34023': {
      ...
      attribution: {
        ...
        license: "Middlesex County's own GIS service (mcgisweb.co.middlesex.nj.us — hosting the near-identical, county-run copy of this parcel layer described in this entry's note above) carries a standard non-warranty disclaimer: the data is \"intended as an information base only\" and \"not intended to replace any legal records,\" with the County assuming \"no responsibility for their positional and content accuracy.\" No explicit commercial-use or redistribution clause was surfaced specifically for the Civil Solutions-hosted ArcGIS Online layer this entry actually queries. Checked via web search 2026-08-18.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '16001': {
      ...
      attribution: {
        ...
        license: "The Ada County Assessor's own GIS User Guide (adacountyassessor.org/public/GISUserGuide_PUBLIC.pdf, \"Restrictions on Use\") states owner name and mailing address are withheld from GIS distribution specifically to comply with the Idaho Public Records Act (Idaho Code 74-120), which bars distributing lists of persons' names/addresses for mailing-list use without consent — consistent with owner data already being absent from this layer's fieldMap. The Assessor's property-search disclaimer separately states data is \"for reference purposes only\" with accuracy not warranted. Checked via web search 2026-08-18; no explicit commercial-redistribution clause was found for the ArcGIS Online \"Parcels\" service itself (hosted by Ada County IT GIS).",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '34017': {
      ...
      attribution: {
        ...
        license: "This entry queries NJOGIS's statewide \"Parcels and MOD-IV Composite of NJ\" service; its published metadata states the parcel polygons \"do not represent legal boundaries\" and \"are not survey data,\" that the State disclaims any duty to maintain or update the data, and that use is subject to the general Conditions of Use for State of New Jersey executive branch web sites. No explicit commercial-use or redistribution restriction beyond that standard disclaimer was found. Checked via web search 2026-08-18.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '34013': {
      ...
      attribution: {
        ...
        portal:  'https://maps.nj.gov/arcgis/rest/services/Framework/Cadastral/MapServer/0',
        license: "Reuses the same statewide NJOGIS \"Parcels and MOD-IV Composite of NJ\" service as Hudson County NJ (see that entry) — the same published metadata disclaimer applies: polygons \"do not represent legal boundaries\" and \"are not survey data,\" the State disclaims any duty to maintain/update the data, and use is subject to the general Conditions of Use for State of New Jersey executive branch web sites. No explicit commercial-use or redistribution restriction beyond that standard disclaimer was found. Checked via web search 2026-08-18.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '48085': {
      ...
      attribution: {
        ...
        license: "CCAD's own Open Data Portal (collincad.org/open-data-portal) states its information \"is considered public domain and distributed as is without warranty of any kind,\" with CCAD disclaiming \"all liability for errors, omissions, or inaccuracies\" — genuinely permissive, no commercial-use or redistribution restriction found. (A separate map/GIS disclaimer on the same domain adds the standard \"not suitable for legal, engineering, or surveying purposes\" caveat.) Checked via web search 2026-08-18; unrelated lookalike domains (collincountypropertyappraiser.org, collincountyappraiserdistrict.org) were not used as sources since they are not the official collincad.org site.",
        license_status: 'PUBLIC_DOMAIN',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: false,
    ...
    '15003': {
      ...
      attribution: {
        ...
        license: "A dataset-specific terms page for this exact geodata.hawaii.gov MapServer layer was not located. Hawaii's statewide open-data terms (opendata.hawaii.gov/pages/terms-of-use), which govern state-hosted GIS data generally, state datasets are provided \"as is, with no representations or warranty as to the completeness, accuracy, functionality, or timeliness,\" with the state not liable for loss or damage from use — a standard disclaimer, no explicit commercial-use restriction found. Separately, the City and County of Honolulu's own open-data terms (data.honolulu.gov/terms-of-use) require an attribution disclaimer on derivative works crediting data.Honolulu.gov, though that portal is not confirmed as the source of this specific layer. Checked via web search 2026-08-18; not verified as applying specifically to this MapServer layer.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '32031': {
      ...
      attribution: {
        ...
        license: "Washoe County's Geospatial Digital Data License Agreement (washoecounty.gov/gis/files/pdfs/GISDataLicenseAgreement.pdf), which downloading data from the county's open-data site obligates users to comply with, is a real and specific commercial-redistribution restriction: it prohibits altering/reformatting the data \"for value added commercial resale or mass distribution of a new product,\" prohibits \"mass copying or reproduction for distribution,\" and prohibits sale, relicensing, transfer, or lease of usage rights to a third party outside the agreement's terms. Checked via web search 2026-08-18.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '56021': {
      ...
      attribution: {
        ...
        license: "The Cheyenne and Laramie County GIS Cooperative's (CLCGISC) own Terms and Conditions, published directly on maps.laramiecounty.com (the same domain hosting this entry's service), state CLCGISC \"invokes its sovereign and governmental immunity in allowing access to or use of this data\" and \"makes no warranties as to the validity, and assumes no liability associated with the use or misuse of this information\" — a standard immunity/no-warranty disclaimer; no explicit commercial-use restriction was found. Checked via web search 2026-08-18.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '10003': {
      ...
      attribution: {
        ...
        license: "New Castle County's website Disclaimer and Privacy Policy (newcastlede.gov/1140/Disclaimer-and-Privacy-Policy) disclaims all warranties of accuracy, completeness, legality, and timeliness for data made available through the site, including warranties of merchantability or fitness for a particular purpose. No explicit clause on commercial use or redistribution was found via web search (2026-08-18); verify directly before commercial use.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '13089': {
      ...
      attribution: {
        ...
        license: "DeKalb County's Terms/Compass Disclaimer (dekalbcounty.org/departments/information-management-office/disclaimer/) states data and content remain county property and that the terms 'do not grant you any right to sell, license, redistribute, or publish the data in bulk or as a database,' with the county reserving the right to restrict access and pursue remedies against unauthorized scraping or automated collection — a real, explicit redistribution restriction (found via web search 2026-08-18).",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '31055': {
      ...
      attribution: {
        ...
        license: "Douglas County Assessor/Register of Deeds' GIS disclaimer (gis.douglascounty-ne.gov) states data is provided 'as is' with no warranty of accuracy, adequacy, completeness, reliability, or usefulness, and that the data 'is available only by permission of the Douglas County Assessor/Register of Deeds,' requiring acceptance of stated conditions of release. A real access restriction, though no separate commercial-use clause was surfaced (web search 2026-08-18); verify directly before commercial use.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '51683': {
      ...
      attribution: {
        ...
        license: "The City of Manassas GIS Disclaimer (gis.manassasva.gov/disclaimer/disclaimer.html) states GIS maps and data are for reference purposes only, not to be used for legal, engineering, or construction determinations or floodplain determination, and that the city assumes no liability for reliance on them — where GIS data conflicts with an official record (Clerk of Circuit Court deeds/plats, Real Estate Assessment values), the official record governs. No explicit commercial-use or redistribution clause was found via web search (2026-08-18); verify directly before commercial use.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '06001': {
      ...
      attribution: {
        ...
        license: "Alameda County's Data Sharing Initiative Terms of Use (acgov.org/acdata/terms.htm) release the county's open datasets under a Public Domain license — no commercial-use restriction was found — subject to the standard 'as is'/'as available' disclaimer of warranty, with the user bearing the cost of correcting any error or defect in the data. Genuinely permissive (found via web search 2026-08-18).",
        license_status: 'PUBLIC_DOMAIN',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: false,
    ...
    '27053': {
      ...
      attribution: {
        ...
        license: "This is the Metropolitan Council's regional MetroGIS Parcel Dataset, made available under the Minnesota Government Data Practices Act (Minn. Stat. Ch. 13) and distributed 'as is' with no warranty of accuracy/completeness. The MetroGIS regional parcel data license (mngeo.state.mn.us) states that some of the seven metro counties' parcel data 'have commercial value and have been maintained as trade secrets and/or non-public information' — meaning commercial-use terms can vary by county, so verify the license specifically for Hennepin before commercial redistribution (found via web search 2026-08-16; the license PDF itself was not directly fetched).",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '06075': {
      ...
      attribution: {
        ...
        license: "DataSF publishes its data under the Public Domain Dedication and License (PDDL) v1.0 (opendatacommons.org/licenses/pddl/1.0/), with supplementary Terms of Use at data.sfgov.org/terms-of-use disclaiming warranty of accuracy and defining rights over 'Derivative Work.' This is a genuinely permissive, public-domain-style license — one of the clearest found in this review (found via web search 2026-08-16). Note this specific feed is a third-party ArcGIS mirror of the DataSF dataset (see note below), not DataSF itself, so the mirror's own re-publication doesn't carry additional restrictions beyond DataSF's PDDL as far as could be determined.",
        license_status: 'PUBLIC_DOMAIN',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: false,
    ...
    '32003': {
      ...
      attribution: {
        ...
        license: "Clark County's GIS host disclaims all warranties and states parcel maps are for assessment use only, not a survey. Separately, the county's Southern Nevada GIS data warehouse requires commercial subscribers to sign a GIS Data Subscriber License Agreement (~$7,500/yr) that explicitly states the data may not be resold. This suggests commercial redistribution of Clark County assessor/parcel data is not permitted without a paid licensing agreement — a real, specific restriction rather than boilerplate (found via web search 2026-08-16).",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '17043': {
      ...
      attribution: {
        ...
        license: "DuPage County publishes its GIS data under its own Open Geo-Spatial Data License – DuPage County, which grants a worldwide, royalty-free, perpetual, non-exclusive license to copy, modify, publish, and redistribute the data 'for any lawful purpose,' explicitly including commercial use, conditioned only on an attribution statement (default: 'Contains information licensed under the Open Geo-Spatial Data License – DuPage County'). Genuinely permissive with a clear attribution requirement (found via web search 2026-08-18).",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '01073': {
      ...
      attribution: {
        ...
        license: "2026-08-19 (Priority D): re-checked via web search, confirming and extending the prior finding rather than replacing it -- the Open Data Hub and Enterprise GIS pages still surface no jurisdiction-specific terms-of-use or license document. New this pass: jccal.org's own general disclaimer text was located and states the Commission does not guarantee this information is accurate or timely and disclaims responsibility for results based on it -- a standard accuracy disclaimer, not an explicit statement on commercial use or redistribution either way. Verify directly before commercial use.",
        license_status: 'TERMS_UNCLEAR',
        commercial_use_status: 'unknown',
        redistribution_status: 'unknown',
        attribution_required: null,
    ...
    '49049': {
      ...
      attribution: {
        ...
        license: "This service is hosted on UGRC's own ArcGIS org (services1.arcgis.com/99lidPhWCzftIe9K, same account as the state's other county SGID feeds), so UGRC's data license and disclaimer policy (gis.utah.gov/about/policy/license-disclaimer/) applies: SGID data including this county's parcels is licensed under Creative Commons Attribution 4.0 International (CC BY 4.0) by default — commercial use is permitted provided UGRC (and the source county) is credited and any changes made to the data are indicated. Genuinely permissive with a clear attribution requirement (found via web search 2026-08-18). Note: Utah County's own GIS site (is.utahcounty.gov/gis) was not separately confirmed to publish under the same terms.",
        license_status: 'ATTRIBUTION_REQUIRED',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: true,
    ...
    '46099': {
      ...
      attribution: {
        ...
        license: "This layer is served by the City of Sioux Falls GIS (not Minnehaha County's own site). The City's DataWorksGov open-data portal (dataworks.siouxfalls.gov) states its licensed data is available for public use under the Creative Commons Attribution 4.0 United States License, alongside a standard 'reference purposes only, not guaranteed accurate/complete' disclaimer. Genuinely permissive with an attribution requirement (found via web search 2026-08-18); Minnehaha County's own site-wide Terms and Conditions were not separately confirmed to add further restriction.",
        license_status: 'ATTRIBUTION_REQUIRED',
        commercial_use_status: 'permitted',
        redistribution_status: 'permitted',
        attribution_required: true,
